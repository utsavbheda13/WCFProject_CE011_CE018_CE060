    ...
    <form id="form1" runat="server">
        <div style="align-items:center;margin-top:40px" class="auto-style4">
                <div style="margin-top:20px;text-align:center" class="auto-style5">
                    <h3 style="background-color: #33CCCC; font-size: larger; font-weight: bold; font-style: normal; color: #FFFFFF; text-decoration: none"> Movie Rating System</h3>
                </div>
                    ...
                    <table class="auto-style1">
                        <tr>
                            <td style="text-align:center">
                                <asp:Button  ID="Reg_id" runat="server" Text="Register" Width="119px" OnClick="Register_User_Click" BackColor="Lime" ForeColor="White" />
                            </td>
                            <td style="text-align:center;">
                                <asp:Button ID="Log_id" runat="server" Text="Login" Width="121px" 
                                    OnClick="Log_id_Click" BackColor="Lime" ForeColor="White" />
                            </td>
                        </tr>
                    </table>
