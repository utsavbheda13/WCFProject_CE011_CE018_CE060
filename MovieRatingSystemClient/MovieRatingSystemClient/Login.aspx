                    ...
                    <table class="auto-style1">
                        <tr>
                            <td style="text-align:center">
                                <asp:Button  ID="Button1" runat="server" Text="Login" Width="119px" OnClick="Login_Click" BackColor="Lime" ForeColor="White" />
                            </td>
                            <td style="text-align:center;">
                                <asp:Button ID="Button2" runat="server" Text="Register" Width="121px" 
                                    OnClick="Button2_Click" BackColor="Lime" ForeColor="White" />
                            </td>
                        </tr>
                    </table>
